...
function CurrentLocationWeather() {
    const [apiLink, setApiLink] = useState('https://api.openweathermap.org/data/2.5/weather?lat=20&lon=50&appid=5d2f9de40d51686b5f3b1ad3e79871bf&lang=pl&units=metric')
        ...
        <div className='currentLocationWeather-box'>
            ...
            <div className='currentLocationWeather-box__container'>
              ...
              <div className='currentLocationWeather-box__container-temp'>
                <p className='weatherTemp'>{currentWeather.temp}°C</p>
                <p>{currentWeather.description}</p>
                <p>Min:{currentWeather.temp_min}°C Max: {currentWeather.temp_max}°C</p>
              </div>
            </div>
        </div>
    )
